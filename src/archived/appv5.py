...
def test_model():
    ...
    y_test = []
    for label in range(26):  # A-Z
        img_path = f"data/{chr(label + 65)}_test.jpg"  # Changed to _test.jpg for test images
        if os.path.exists(img_path):
            img = Image.open(img_path)
...
def main():
    ...
    if choice == "Home":
        ...
        st.write("Make sure you have the training data in the 'data' directory.")
        ...
        st.write("Make sure you have the test data in the 'data' directory.")
